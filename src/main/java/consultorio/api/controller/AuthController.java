        ...
        path("/api/auth", () -> {
            ...
            post("/register", (req, res) -> {
                ...
                if (r.getEmail() == null || r.getPassword() == null || r.getNombre() == null) {
                    res.status(400);
                    return gson.toJson(java.util.Map.of("error", "Faltan campos obligatorios (nombre, email, password)"));
                }
                ...
                if (usuarioDAO.buscarPorEmail(emailNormalized) != null) {
                    res.status(409);
                    return gson.toJson(java.util.Map.of("error", "El correo ya está registrado"));
                }
                ...
                try {
                    ...
                    res.status(500);
                    return gson.toJson(java.util.Map.of("error", "Error al crear usuario: " + e.getMessage()));
                }
            });
            ...
            post("/login", (req, res) -> {
                ...
                try {
                    ...
                    res.status(400);
                    return gson.toJson(java.util.Map.of("error", "JSON inválido"));
                }

                if (lr.getEmail() == null || lr.getPassword() == null) {
                    res.status(400);
                    return gson.toJson(java.util.Map.of("error", "Faltan campos (email o password)"));
                }
                ...
                if (u == null || !BCrypt.checkpw(lr.getPassword(), u.getPasswordHash())) {
                    res.status(401);
                    return gson.toJson(java.util.Map.of("error", "Credenciales incorrectas"));
                }
